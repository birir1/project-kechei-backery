<div style="background-color: #f9f9f9; padding: 2rem; font-family: 'Times New Roman', serif;">
    <div style="max-width: 700px; margin: 0 auto; background-color: #ffffff; border-radius: 0.5rem; padding: 2rem; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        <h2 style="font-size: 1.8rem; font-weight: bold; color: #143009; text-align: center; margin-bottom: 1rem;">Suggestions Welcome</h2>
        <p style="color: #666565; font-size: 1rem; text-align: center; margin-bottom: 1.5rem;">
