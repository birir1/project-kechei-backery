<section id="unique-pastries" class="bg-white py-12">
    <div class="max-w-7xl mx-auto text-center">
        <h2 class="text-4xl font-bold mb-6 text-[#7A2D6D]">Unique Pastries</h2>
        <p class="mb-8 text-gray-600 text-lg">Explore our selection of one-of-a-kind pastries crafted with love and creativity.</p>
        ...
        <div class="flex flex-wrap justify-center gap-6">
            ...
            <div class="bg-[#f9f9f9] border rounded-lg shadow-md w-64">
                ...
                <div class="p-4">
                    ...
                    <a href="/order/lavender-puff" class="block text-center bg-[#7A2D6D] text-white py-2 rounded hover:bg-[#a63f6d] transition">Order Now</a>
                </div>
            </div>
            ...
            <div class="bg-[#f9f9f9] border rounded-lg shadow-md w-64">
                ...
                <div class="p-4">
                    ...
                    <a href="/order/matcha-croissant" class="block text-center bg-[#7A2D6D] text-white py-2 rounded hover:bg-[#a63f6d] transition">Order Now</a>
                </div>
            </div>
            ...
            <div class="bg-[#f9f9f9] border rounded-lg shadow-md w-64">
                ...
                <div class="p-4">
                    ...
                    <a href="/order/spicy-chocolate-tart" class="block text-center bg-[#7A2D6D] text-white py-2 rounded hover:bg-[#a63f6d] transition">Order Now</a>
                </div>
            </div>
        </div>
    </div>
