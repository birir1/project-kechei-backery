<section id="rye-loaves" class="bg-[#f4f7f6] py-10">
    <div class="max-w-7xl mx-auto text-center">
        <h2 class="text-3xl font-bold mb-6">Rye Loaves</h2>
        <p class="mb-8 text-gray-700">Discover the rich and robust flavors of our artisan rye loaves. Each loaf is crafted with care to deliver a delightful taste experience.</p>
        ...
        <div class="mt-10">
            <h4 class="text-2xl font-bold mb-4">Why Choose Rye?</h4>
            <p class="text-gray-700 max-w-3xl mx-auto">Rye bread is not only delicious but also packed with nutrients. It’s known for its high fiber content, which aids digestion, and has a lower glycemic index compared to wheat bread, making it a healthier choice for many. Enjoy our rye loaves with a variety of toppings or on their own for a satisfying meal.</p>
        </div>
    </div>
</section>
