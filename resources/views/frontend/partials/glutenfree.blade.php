<section id="gluten-free-options" class="bg-white py-10">
    <div class="max-w-7xl mx-auto text-center">
        <h2 class="text-3xl font-bold mb-6">Gluten-Free Options</h2>
        <p class="mb-8 text-gray-700">Indulge in our selection of delicious gluten-free baked goods, crafted with care to ensure a satisfying taste experience without the gluten.</p>
        ...
        <div class="mt-10">
            <h4 class="text-2xl font-bold mb-4">Why Choose Gluten-Free?</h4>
            <p class="text-gray-700 max-w-3xl mx-auto">Whether you have a gluten intolerance or simply prefer gluten-free options, our baked goods are crafted with the finest ingredients to ensure taste and texture without compromising on flavor. Indulge in our gluten-free selections that everyone can enjoy!</p>
        </div>
    </div>
</section>
