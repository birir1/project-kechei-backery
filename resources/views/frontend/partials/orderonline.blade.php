<section id="order-online" class="bg-[#f8f9fa] py-16">
    <div class="max-w-5xl mx-auto px-6 text-center">
        ...
        <div class="flex justify-center">
            <a href="/order" class="bg-[#ff6f61] text-white text-xl font-semibold py-4 px-10 rounded-full shadow-lg hover:bg-[#e65c53] transition duration-200">
                Start Your Order
            </a>
        </div>
        ...
        <div class="flex flex-col lg:flex-row justify-between items-center mt-12 space-y-8 lg:space-y-0 lg:space-x-6">
            ...
            <div class="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
                <img src="path/to/fast-delivery-icon.png" alt="Fast Delivery" class="w-16 h-16 mb-4">
            ...
            <div class="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
                <img src="path/to/fresh-ingredients-icon.png" alt="Fresh Ingredients" class="w-16 h-16 mb-4">
            ...
            <div class="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
                <img src="path/to/secure-payment-icon.png" alt="Secure Payment" class="w-16 h-16 mb-4">
